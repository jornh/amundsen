...
Please visit the Amundsen installation documentation for a [quick start](/docs/installation.md#bootstrap-amundsen-using-docker) to bootstrap a default version of Amundsen with dummy data.
